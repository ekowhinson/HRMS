    ...
    def get(self, request):
        ...
        for idx, item in enumerate(items, 1):
            ...
            employees_data.append({
                ...
                'full_name': item.employee.full_name,
                'department': item.employee.department.name if item.employee.department else 'Unassigned',
                'grade': item.employee.grade.name if item.employee.grade else 'Unassigned',
                'staff_category': item.employee.staff_category.name if item.employee.staff_category else 'Unassigned',
